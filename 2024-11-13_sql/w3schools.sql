...
-- ALTER TABLE `categories` MODIFY `CategoryID` integer NOT NULL AUTO_INCREMENT,
-- AUTO_INCREMENT = 9;
--
CREATE TABLE
  categories (
...
-- Set the initial value for AUTOINCREMENT
INSERT INTO
...
-- ALTER TABLE `orders` ADD CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`CustomerID`) REFERENCES `customers` (`CustomerID`),
...
--ALTER TABLE `order_details` MODIFY `OrderDetailID` integer NOT NULL AUTO_INCREMENT,
-- ALTER TABLE `order_details` ADD CONSTRAINT `order_details_ibfk_1` FOREIGN KEY (`OrderID`) REFERENCES `orders` (`OrderID`),
...
--ALTER TABLE `products` MODIFY `ProductID` integer NOT NULL AUTO_INCREMENT,
...
-- ALTER TABLE `suppliers` MODIFY `SupplierID` integer NOT NULL AUTO_INCREMENT,
CREATE TABLE
  `suppliers` (
